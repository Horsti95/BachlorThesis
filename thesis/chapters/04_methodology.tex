...
\midrule
Layer 1 & 149 features (NPZ) & $\sim$1.1 MB & Persistent Storage & Implemented \\
Layer 2 & Trained LOSO models & 1--150 MB & Fingerprint Cache & Implemented \& Verified \\
\bottomrule
\end{tabular}
...
\begin{missingref}
TODO Lennart: Add the actual BOAS dataset citation. The current bib file
contains \texttt{kemp2000sleepEDF} and \texttt{goldberger2000physionet}, which
reference the Sleep-EDF dataset and PhysioNet platform, not BOAS. Search
OpenNeuro or the Bitbrain website for the correct BOAS paper reference and add
a \texttt{\\cite\{boas\_dataset\}} call here.
\end{missingref}
...
This chapter presents the measured experimental results for the fingerprint-based
LOSO caching framework, followed by key findings and a critical discussion of
the approach.

% ----------------------------------------------------------------------------
\section{Caching Performance Results}
\label{sec:results_caching}
% ----------------------------------------------------------------------------

\subsection{XGBoost LOSO Cache Evaluation}
...
\subsection{Random Forest LOSO Cache Evaluation}
...
\subsection{XGBoost vs.\ Random Forest Comparison}
...
dramatically smaller cache footprint.
...
% ----------------------------------------------------------------------------
\section{Multi-Model Cache Viability}
...
speedup at only 0.4~MB per fold.

% ----------------------------------------------------------------------------
\section{Cache Scaling with Dataset Size}
...
% ----------------------------------------------------------------------------
\section{Feature Selection: ANOVA vs.\ Mutual Information}
